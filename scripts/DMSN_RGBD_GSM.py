...
from DMSN_module_RGBD_Depth_WIL import DMSN_module
...
def train(data, scene, mdl_path, vgg_weights_path):
    ...
    model = MFCN_module(lr, img_shape, scene, vgg_weights_path)
...
main_dir = os.path.join('..', 'DMSN_Depth_WIL')
...
for scene in dataset:
    ...
    mdl_path = os.path.join(main_mdl_dir, 'mdl_GSM_RGBD_Depth_WIL_'+ str(scene) + '.h5')
