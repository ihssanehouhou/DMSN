...
class DMSN_module(object):
    ...
    # def IMSC_D(self, d_F1, d_F2, d_F3, d_F4, d_F5):

    #     d_X1 = Conv2D(128, (3, 3), activation='relu', padding='same', name='d_X1_conv')(d_F1)
    #     d_AvX1 = AveragePooling2D((3, 3), strides=(1, 1), padding='same', name='d_APX1')(d_X1)
    #     d_C1 = Subtract()([d_X1, d_AvX1])
    #     d_X2 = Conv2D(128, (3, 3), activation='relu', padding='same', name='d_X2_conv')(d_F2)
    #     d_AvX2 = AveragePooling2D((3, 3), strides=(1, 1), padding='same', name='d_APX2')(d_X2)
    #     d_C2 = Subtract()([d_X2, d_AvX2])
    #     d_X3 = Conv2D(128, (3, 3), activation='relu', padding='same', name='d_X3_conv')(d_F3)
    #     d_AvX3 = AveragePooling2D((3, 3), strides=(1, 1), padding='same', name='d_APX3')(d_X3)
    #     d_C3 = Subtract()([d_X3, d_AvX3])
    #     d_X4 = Conv2D(128, (3, 3), activation='relu', padding='same', name='d_X4_conv')(d_F4)
    #     d_AvX4 = AveragePooling2D((3, 3), strides=(1, 1), padding='same', name='d_APX4')(d_X4)
    #     d_C4 = Subtract()([d_X4, d_AvX4])
    #     d_X5 = Conv2D(128, (3, 3), activation='relu', padding='same', name='d_X5_conv')(d_F5)
    #     d_AvX5 = AveragePooling2D((3, 3), strides=(1, 1), padding='same', name='d_APX5')(d_X5)
    #     d_C5 = Subtract()([d_X5, d_AvX5])
        
        
    #     return d_X1, d_X2, d_X3, d_X4, d_X5, d_C1, d_C2, d_C3, d_C4, d_C5

    #InterMediat Skeep Connection
    def IMSC(self, F1, F2, F3, F4, F5, d_F1, d_F2, d_F3, d_F4, d_F5):

        CF1 = concatenate([F1, d_F1], name='DC_F1_d_F1')

        X1 = Conv2D(128, (3, 3), activation='relu', padding='same', name='X1_conv')(CF1)
        AvX1 = AveragePooling2D((3, 3), strides=(1, 1), padding='same', name='APX1')(X1)
        C1 = Subtract()([X1, AvX1])

        CF2 = concatenate([F2, d_F2], name='DC_F2_d_F2')
        X2 = Conv2D(128, (3, 3), activation='relu', padding='same', name='X2_conv')(CF2)
        AvX2 = AveragePooling2D((3, 3), strides=(1, 1), padding='same', name='APX2')(X2)
        C2 = Subtract()([X2, AvX2])

        CF3 = concatenate([F3, d_F3], name='DC_F3_d_F3')
        X3 = Conv2D(128, (3, 3), activation='relu', padding='same', name='X3_conv')(CF3)
        AvX3 = AveragePooling2D((3, 3), strides=(1, 1), padding='same', name='APX3')(X3)
        C3 = Subtract()([X3, AvX3])

        CF4 = concatenate([F4, d_F4], name='DC_F4_d_F4')
        X4 = Conv2D(128, (3, 3), activation='relu', padding='same', name='X4_conv')(CF4)
        AvX4 = AveragePooling2D((3, 3), strides=(1, 1), padding='same', name='APX4')(X4)
        C4 = Subtract()([X4, AvX4])

        CF5 = concatenate([F5, d_F5], name='DC_F5_d_F5')
        X5 = Conv2D(128, (3, 3), activation='relu', padding='same', name='X5_conv')(CF5)
    ...
    def initModel(self, dataset_name):
        ...
        X1, X2, X3, X4, X5, C1, C2, C3, C4, C5 = self.IMSC(F1, F2, F3, F4, F5, d_F1, d_F2, d_F3, d_F4, d_F5)
        x = self.decoder(X1, X2, X3, X4, X5, C1, C2, C3, C4, C5)
