...
#from my_upsampling_2d import MyUpSampling2Df
...
class DMSN_module(object):
    ...
    def decoder(self, X1, X2, X3, X4, X5, C1, C2, C3, C4, C5, d_X1, d_X2, d_X3, d_X4, d_X5, d_C1, d_C2, d_C3, d_C4, d_C5):
        DC5 = concatenate([X5, C5, d_X5, d_C5], name='DC_X5_C5')
        D5 = Conv2DTranspose(128, (3, 3), strides=(2, 2), activation='relu', padding='same', name='D5')(DC5)

        DC4 = concatenate([X4, C4, d_X4, d_C4, D5], name='DC_X4_C4')
        D4 = Conv2DTranspose(256, (3, 3), strides=(2, 2), activation='relu', padding='same', name='D4')(DC4)

        DC3 = concatenate([X3, C3, d_X3, d_C3, D4], name='DC_X3_C3')
        D3 = Conv2DTranspose(384, (3, 3), strides=(2, 2), activation='relu', padding='same', name='D3')(DC3)

        DC2 = concatenate([X2, C2, d_X2, d_C2, D3], name='DC_X2_C2')
        D2 = Conv2DTranspose(512, (3, 3), strides=(2, 2), activation='relu', padding='same', name='D2')(DC2)

        DC1 = concatenate([X1, C1, d_X1, d_C1, D2], name='DC_X1_C1')
    ...
    def initModel(self, dataset_name):
        ...
        x = self.decoder(X1, X2, X3, X4, X5, C1, C2, C3, C4, C5, d_X1, d_X2, d_X3, d_X4, d_X5, d_C1, d_C2, d_C3, d_C4, d_C5)
