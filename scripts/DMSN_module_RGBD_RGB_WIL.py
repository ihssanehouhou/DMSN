...
class DMSN_module(object):
    ...
    def initModel(self, dataset_name):
        ...
        x = self.decoder(F1, F2, F3, F4, F5, d_X1, d_X2, d_X3, d_X4, d_X5, d_C1, d_C2, d_C3, d_C4, d_C5)
