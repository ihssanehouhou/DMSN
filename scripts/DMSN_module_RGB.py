...
from keras.layers import Input, Dropout, Activation, SpatialDropout2D, Softmax
...
class DMSN_module(object):
    ...
    def initModel(self, dataset_name):
        ...
        # unfreeze_layers = ['block3_conv1','block3_conv2', 'block3_conv3', 'block4_conv1','block4_conv2', 'block4_conv3', 'block5_conv1','block5_conv2', 'block5_conv3']
