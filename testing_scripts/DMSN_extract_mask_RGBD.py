...
# 2. model dir
main_mdl_dir = os.path.join('DMSN_Depth_WIL', 'SBMRGBD', 'models')

# 3. path to store results
results_dir = os.path.join('DMSN_Depth_WIL', 'SBMRGBD', 'results', 'RGBD_D1CH')
...
for scene in dataset:
        # print ('\n->>> ' + category + ' / ' + scene)
        print ('\n->>> ' + scene)
        mdl_path = os.path.join('..', main_mdl_dir, 'mdl_SBMRGBD_RGBD_Depth_WIL_' + scene + '_D1CH.h5')
