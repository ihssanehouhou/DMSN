...
# 2. model dir
main_mdl_dir = os.path.join('DMSN_RGBD_One_Stream', 'GSM', 'models')

# 3. path to store results
results_dir = os.path.join('DMSN_RGBD_One_Stream', 'GSM', 'results', 'RGB')
...
for scene in dataset:
        # print ('\n->>> ' + category + ' / ' + scene)
        print ('\n->>> ' + scene)
        mdl_path = os.path.join('..', main_mdl_dir, 'DMSN_RGBD_One_Stream_mdl_GSM_RGB_' + scene + '.h5')
